const messages = {
  ...
  bidPlacedSuccess: "Bid placed successfully!", // New success message
  bidPlacedError: "Failed to place bid. Please try again.", // New error message
  error: "Something went wrong. Please try again.",
};

export function showMessage(type, key, containerId = "messages-container") {
  const message = messages[key] || key; // Use predefined message or custom text
